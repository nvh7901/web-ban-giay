    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="page-title">List Sliders</h3>
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="example1"
                                                            ...
                                                            style="width: 167.062px;">Slider Title Vi</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example1"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Office: activate to sort column ascending"
                                                            style="width: 167.062px;">Slider Title En</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example1"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Office: activate to sort column ascending"
                                                            style="width: 50.062px;">Status</th>
                                                        <th class="sorting" tabindex="0" aria-controls="example1"
                                                            rowspan="1" colspan="1"
                                                    ...
                                                    @foreach ($data as $slider)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                ...
                                                                @if ($slider->status == 1)
                                                                    <a href="/admin/slider/in-active/{{ $slider->id }}"
                                                                ...
                                                                @else
                                                                    <a href="/admin/slider/active/{{ $slider->id }}"
